Disclaimer: This folder is the source code from Amigoscode spring boot fullstack professional course (https://github.com/amigoscode/spring-boot-fullstack-professional).

It is also the repository used for the Testing tutorial (https://www.youtube.com/watch?v=Geq60OVyBPg), that's why it is used here.

In summary, all of the info here comes from Amigoscode repository, except for my own commentaries for studying purposes.
