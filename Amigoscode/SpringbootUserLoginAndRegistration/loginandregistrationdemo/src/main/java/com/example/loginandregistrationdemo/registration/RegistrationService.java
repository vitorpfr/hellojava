...
public class RegistrationService {
    ...
    public static final String EMAIL_NOT_VALID_MSG = "The e-mail %s provided is not valid";
    public static final String TOKEN_NOT_FOUND_MSG = "Token not found";
    public static final String TOKEN_EXPIRED_MSG = "Token expired";
    public static final String EMAIL_ALREADY_CONFIRMED_MSG = "E-mail already confirmed";
    ...
    public String register(RegistrationRequest request) {
        ...
        if (!isValidEmail) {
            // better ways of handling case here
    ...
    // Transactional annotation makes this method all-or-nothing: either both changes inside it happen or none (atomicity)
    @Transactional
